...
function loadProducts() {
  ...
  carts.forEach((element, index) => {
    ...
    priceP.className =
      "product-price text-custom fw-bold mb-0 text-decoration-underline";
